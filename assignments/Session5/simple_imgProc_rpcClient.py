...
def on_response(ch, method, props, body) :
    ...
    print("reponse : {}".format(decoded_response))
...
def setup_connection() :
    ...
    request_msg = settings["invert_color"]
    #OR
    #request_msg = settings["threshold"]
    #OR a filter that doesn't exist
    #request_msg = settings["no_exist"]
